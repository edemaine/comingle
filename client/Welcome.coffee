    ...
    <Card.Body>
      ...
      <ul>
        ...
        <li>When you click a second room, you'll have two choices:
          <ul>
            <li> "<b>Switch to Room</b>" (shortcut: hold <kbd>Shift</kbd>
              while clicking) opens the room as a new tab and immediately
              switches to it.  Note that this will <b>disconnect</b> you
              from any current Comingle video call.</li>
            <li> "<b>Open in Background</b>" (shortcut: hold
              <kbd>Ctrl/Cmd</kbd> while clicking) opens the room
              as a new tab, but you stay in your current room.
              You can switch to it later by clicking on the tab.</li>
          </ul>
        </li>
        <li>Each room contains one or more <b>tabs</b>: video call,
          whiteboard, etc.
